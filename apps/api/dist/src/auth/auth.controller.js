...
let AuthController = class AuthController {
    ...
    logout(user) { return this.auth.logout(user.sub); }
    me(user) { return this.auth.me(user.sub); }
    updateMe(user, dto) { return this.auth.updateMe(user.sub, dto); }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, auth_dto_1.UpdateMeDto]),
    __metadata("design:returntype", void 0)

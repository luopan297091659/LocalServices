...
let ConversationsController = class ConversationsController {
    ...
    create(user, dto) { return this.conversations.create(user, dto); }
    list(user) { return this.conversations.list(user); }
    get(user, id) { return this.conversations.get(user, id); }
    messages(user, id) { return this.conversations.messages(user, id); }
    send(user, id, dto) { return this.conversations.send(user, id, dto); }
    read(user, id) { return this.conversations.read(user, id); }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, conversation_dto_1.MessageDto]),
    __metadata("design:returntype", void 0)

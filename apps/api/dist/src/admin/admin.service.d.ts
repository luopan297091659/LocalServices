...
export declare class AdminService {
    ...
    updateUser(id: string, status: 'ACTIVE' | 'SUSPENDED' | 'DELETED'): import(".prisma/client").Prisma.Prisma__UserClient<{
        email: string | null;
        phone: string | null;
        nickname: string | null;
    ...
    approve(adminId: string, id: string, ip?: string): Promise<{
        email: string | null;
        phone: string | null;
        id: string;
        status: import(".prisma/client").$Enums.MerchantStatus;
    ...
    reject(adminId: string, id: string, dto: RejectMerchantDto, ip?: string): Promise<{
        email: string | null;
        phone: string | null;
        id: string;
        status: import(".prisma/client").$Enums.MerchantStatus;
    ...
    status(adminId: string, id: string, status: MerchantStatus, ip?: string): Promise<{
        email: string | null;
        phone: string | null;
        id: string;
        status: import(".prisma/client").$Enums.MerchantStatus;

...
describe('validateEnvironment', () => {
  it('rejects weak production secrets', () => {
    expect(() => validateEnvironment({ NODE_ENV: 'production', DATABASE_URL: 'postgresql://user:strong-password@localhost/db', APP_URL: 'https://services.machi.jp', JWT_SECRET: 'short', JWT_REFRESH_SECRET: 'also-short' })).toThrow('JWT_SECRET');
  });

...
<template>
  ...
  <section class="cta"><div><span class="eyebrow">FOR LOCAL BUSINESSES</span><h2>あなたのお店を、<br>もっと地域の人へ。</h2><p>無料で店舗情報を掲載。サービスの魅力を発信して、新しいお客様と出会いませんか？</p><a href="/merchant-admin/" class="cta-button">店舗を無料で登録する <span>→</span></a></div><div class="cta-art"><span>ま</span><i>LOCAL BUSINESS<br>GROW TOGETHER</i></div></section>
</template>
